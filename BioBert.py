...
datasets['train'] = concatenate_datasets([bc5cdr['train'],ncbi['train']])
datasets['validation'] = concatenate_datasets([bc5cdr['validation'],ncbi['validation']])
datasets['test'] = concatenate_datasets([bc5cdr['test'],ncbi['test']])
print(datasets)
